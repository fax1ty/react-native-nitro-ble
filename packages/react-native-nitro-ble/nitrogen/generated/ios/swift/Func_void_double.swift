...
/**
 * Wraps a Swift `(_ error: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.bluetooth.bridge.swift

  private let closure: (_ error: Double) -> Void

  public init(_ closure: @escaping (_ error: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(error: Double) -> Void {
    self.closure(error)
  }
