...
namespace margelo::nitro::bluetooth {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/bluetooth/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/bluetooth/Func_void_cxx;";
